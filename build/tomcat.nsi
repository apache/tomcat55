...
Section "Native" SecTomcatNative
  ...
  NSISdl::download /TIMEOUT=30000 http://tomcat.heanet.ie/native/1.1.2/binaries/win32/tcnative-1.dll $INSTDIR\bin\tcnative-1.dll
  Pop $0
  StrCmp $0 success success
    SetDetailsView show
    DetailPrint "download failed from http://tomcat.heanet.ie/native/1.1.2/binaries/win32/tcnative-1.dll: $0"
  success:
